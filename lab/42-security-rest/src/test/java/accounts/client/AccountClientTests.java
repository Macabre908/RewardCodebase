...
public class AccountClientTests {
    ...
    public void createAccount_using_user_should_return_403() throws Exception {
        ...
        Account newAccount = new Account("5678956789", "Mauli");
        ResponseEntity<Void> responseEntity = restTemplate.withBasicAuth("user",  "user")
                .postForEntity(url, newAccount, Void.class);
